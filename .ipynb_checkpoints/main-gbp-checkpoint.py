...
plt.savefig('/home/ubuntu/files/{project_name}/results/myHistogramFromPython.png'.format(project_name=os.environ["DOMINO_PROJECT_NAME"]), format='png')
...
with open('/home/ubuntu/files/{project_name}/results/dominostats.json'.format(project_name=os.environ["DOMINO_PROJECT_NAME"]), 'w') as f:
